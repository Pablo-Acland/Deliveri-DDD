...
public class PaqueteAdded extends DomainEvent {
    private final PaqueteID paqueteID;
    private final Descripcion descripcion;

    public PaqueteAdded(PaqueteID paqueteID, Descripcion descripcion) {
        super("com.sofka.deliveri.pedido.paqueteadded");
